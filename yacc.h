...
#pragma GCC message "bison: do not #define YYSTYPE in C++, use %define api.value.type"
        ...
        struct token
        {
            enum token_kind_type
            {
                ...
                TOKEN_ASSIGN        = 284,  // ASSIGN
                TOKEN_PLUS          = 285,  // PLUS
                TOKEN_MINUS         = 286,  // MINUS
                TOKEN_STAR          = 287,  // STAR
                TOKEN_SLASH         = 288,  // SLASH
                TOKEN_MOD           = 289,  // MOD
                TOKEN_EQ            = 290,  // EQ
                TOKEN_NE            = 291,  // NE
                TOKEN_LT            = 292,  // LT
        ...
        struct symbol_kind
        {
            enum symbol_kind_type
            {
                ...
                S_STMT_LIST                 = 48,  // STMT_LIST
                S_STMT                      = 49,  // STMT
                S_BLOCK_STMT                = 50,  // BLOCK_STMT
                S_CONTINUE_STMT             = 51,  // CONTINUE_STMT
                S_EXPR_STMT                 = 52,  // EXPR_STMT
                S_VAR_DECLARATION           = 53,  // VAR_DECLARATION
                S_VAR_DECL_STMT             = 54,  // VAR_DECL_STMT
                S_FUNC_DECL_STMT            = 55,  // FUNC_DECL_STMT
                S_FOR_STMT                  = 56,  // FOR_STMT
                S_IF_STMT                   = 57,  // IF_STMT
                S_RETURN_STMT               = 58,  // RETURN_STMT
                S_WHILE_STMT                = 59,  // WHILE_STMT
                S_BREAK_STMT                = 60,  // BREAK_STMT
                S_PARAM_DECLARATOR          = 61,  // PARAM_DECLARATOR
                S_PARAM_ARRAY_DIMS          = 62,  // PARAM_ARRAY_DIMS
                S_PARAM_ARRAY_DIMS_TAIL     = 63,  // PARAM_ARRAY_DIMS_TAIL
                S_PARAM_DECLARATOR_LIST     = 64,  // PARAM_DECLARATOR_LIST
                S_VAR_DECLARATOR            = 65,  // VAR_DECLARATOR
                S_VAR_DECLARATOR_LIST       = 66,  // VAR_DECLARATOR_LIST
                S_INITIALIZER               = 67,  // INITIALIZER
                S_INITIALIZER_LIST          = 68,  // INITIALIZER_LIST
                S_ASSIGN_EXPR               = 69,  // ASSIGN_EXPR
                S_EXPR_LIST                 = 70,  // EXPR_LIST
                S_EXPR                      = 71,  // EXPR
                S_NOCOMMA_EXPR              = 72,  // NOCOMMA_EXPR
                S_LOGICAL_OR_EXPR           = 73,  // LOGICAL_OR_EXPR
                S_LOGICAL_AND_EXPR          = 74,  // LOGICAL_AND_EXPR
                S_EQUALITY_EXPR             = 75,  // EQUALITY_EXPR
                S_RELATIONAL_EXPR           = 76,  // RELATIONAL_EXPR
                S_ADDSUB_EXPR               = 77,  // ADDSUB_EXPR
                S_MULDIV_EXPR               = 78,  // MULDIV_EXPR
                S_UNARY_EXPR                = 79,  // UNARY_EXPR
                S_BASIC_EXPR                = 80,  // BASIC_EXPR
                S_FUNC_CALL_EXPR            = 81,  // FUNC_CALL_EXPR
                S_ARRAY_DIMENSION_EXPR      = 82,  // ARRAY_DIMENSION_EXPR
                S_ARRAY_DIMENSION_EXPR_LIST = 83,  // ARRAY_DIMENSION_EXPR_LIST
                S_LEFT_VAL_EXPR             = 84,  // LEFT_VAL_EXPR
                S_LITERAL_EXPR              = 85,  // LITERAL_EXPR
                S_TYPE                      = 86,  // TYPE
                S_UNARY_OP                  = 87   // UNARY_OP
            };
        };
        ...
        struct symbol_type : basic_symbol<by_kind>
        {
...
#endif
            {
                ...
                YY_ASSERT(tok == token::TOKEN_YYEOF || (token::TOKEN_YYerror <= tok && tok <= token::TOKEN_YYUNDEF) ||
                          tok == token::TOKEN_FLOAT || (token::TOKEN_INT <= tok && tok <= token::TOKEN_VOID) ||
...
#if !defined _MSC_VER || defined __clang__
                YY_ASSERT(
                    (token::TOKEN_STR_CONST <= tok && tok <= token::TOKEN_SLASH_COMMENT) || tok == token::TOKEN_IDENT);
#endif
            }
        };
...
#line 2847 "frontend/parser/yacc.h"

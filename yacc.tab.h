...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOKEN_ASSIGN = 287,            // ASSIGN
    TOKEN_PLUS = 288,              // PLUS
    TOKEN_MINUS = 289,             // MINUS
    TOKEN_STAR = 290,              // STAR
    TOKEN_SLASH = 291,             // SLASH
    TOKEN_MOD = 292,               // MOD
    TOKEN_EQ = 293,                // EQ
    TOKEN_NE = 294,                // NE
    TOKEN_LT = 295,                // LT
    ...
    TOKEN_OR = 300,                // OR
    TOKEN_NOT = 301,               // NOT
    TOKEN_BITAND = 302,            // BITAND
    TOKEN_BITOR = 303,             // BITOR
    TOKEN_BITXOR = 304,            // BITXOR
    TOKEN_BITNOT = 305,            // BITNOT
    TOKEN_SHL = 306,               // SHL
    TOKEN_SHR = 307,               // SHR
    TOKEN_PLUSEQ = 308,            // PLUSEQ
    TOKEN_MINUSEQ = 309,           // MINUSEQ
    TOKEN_MULEQ = 310,             // MULEQ
    TOKEN_DIVEQ = 311,             // DIVEQ
    TOKEN_MODEQ = 312,             // MODEQ
    TOKEN_ANDEQ = 313,             // ANDEQ
    TOKEN_OREQ = 314,              // OREQ
    TOKEN_XOREQ = 315,             // XOREQ
    TOKEN_SHLEQ = 316,             // SHLEQ
    TOKEN_SHREQ = 317,             // SHREQ
    TOKEN_INC = 318,               // INC
    TOKEN_DEC = 319,               // DEC
    TOKEN_DOT = 320,               // DOT
    TOKEN_ARROW = 321,             // ARROW
    TOKEN_COLON = 322,             // COLON
    TOKEN_QUESTION = 323,          // QUESTION
    TOKEN_END = 324,               // END
    TOKEN_THEN = 325               // THEN
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_STMT = 74,                             // STMT
        S_BLOCK_STMT = 75,                       // BLOCK_STMT
        S_CONTINUE_STMT = 76,                    // CONTINUE_STMT
        S_EXPR_STMT = 77,                        // EXPR_STMT
        S_VAR_DECLARATION = 78,                  // VAR_DECLARATION
        S_VAR_DECL_STMT = 79,                    // VAR_DECL_STMT
        S_FUNC_BODY = 80,                        // FUNC_BODY
        S_FUNC_DECL_STMT = 81,                   // FUNC_DECL_STMT
        S_FOR_STMT = 82,                         // FOR_STMT
        S_IF_STMT = 83,                          // IF_STMT
        S_RETURN_STMT = 84,                      // RETURN_STMT
        S_WHILE_STMT = 85,                       // WHILE_STMT
        S_BREAK_STMT = 86,                       // BREAK_STMT
        S_PARAM_DECLARATOR = 87,                 // PARAM_DECLARATOR
        S_PARAM_ARRAY_DIMS = 88,                 // PARAM_ARRAY_DIMS
        S_PARAM_ARRAY_DIMS_TAIL = 89,            // PARAM_ARRAY_DIMS_TAIL
        S_PARAM_DECLARATOR_LIST = 90,            // PARAM_DECLARATOR_LIST
        S_VAR_DECLARATOR = 91,                   // VAR_DECLARATOR
        S_VAR_DECLARATOR_LIST = 92,              // VAR_DECLARATOR_LIST
        S_INITIALIZER = 93,                      // INITIALIZER
        S_INITIALIZER_LIST = 94,                 // INITIALIZER_LIST
        S_ASSIGN_EXPR = 95,                      // ASSIGN_EXPR
        S_EXPR_LIST = 96,                        // EXPR_LIST
        S_EXPR = 97,                             // EXPR
        S_NOCOMMA_EXPR = 98,                     // NOCOMMA_EXPR
        S_LOGICAL_OR_EXPR = 99,                  // LOGICAL_OR_EXPR
        S_LOGICAL_AND_EXPR = 100,                // LOGICAL_AND_EXPR
        S_EQUALITY_EXPR = 101,                   // EQUALITY_EXPR
        S_RELATIONAL_EXPR = 102,                 // RELATIONAL_EXPR
        S_ADDSUB_EXPR = 103,                     // ADDSUB_EXPR
        S_MULDIV_EXPR = 104,                     // MULDIV_EXPR
        S_UNARY_EXPR = 105,                      // UNARY_EXPR
        S_BASIC_EXPR = 106,                      // BASIC_EXPR
        S_FUNC_CALL_EXPR = 107,                  // FUNC_CALL_EXPR
        S_ARRAY_DIMENSION_EXPR = 108,            // ARRAY_DIMENSION_EXPR
        S_ARRAY_DIMENSION_EXPR_LIST = 109,       // ARRAY_DIMENSION_EXPR_LIST
        S_LEFT_VAL_EXPR = 110,                   // LEFT_VAL_EXPR
        S_LITERAL_EXPR = 111,                    // LITERAL_EXPR
        S_TYPE = 112,                            // TYPE
        S_UNARY_OP = 113                         // UNARY_OP
      };
    };
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      {
        return symbol_type (token::TOKEN_SHL, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOKEN_SHR, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOKEN_ANDEQ, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOKEN_ANDEQ, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOKEN_OREQ, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOKEN_OREQ, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOKEN_XOREQ, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOKEN_XOREQ, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOKEN_SHLEQ, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOKEN_SHLEQ, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOKEN_SHREQ, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOKEN_SHREQ, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOKEN_INC, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOKEN_DEC, std::move (l));
      }
#else
      static
      symbol_type

...
static const flex_int16_t yy_base[123] = {0,
    0,
    0,
    158,
    398,
...
static const flex_int16_t yy_def[123] = {0,
    114,
    1,
    114,
    114,
...
static const flex_int16_t yy_nxt[450] = {0,
    4,
    5,
    6,
    7,
...
static const flex_int16_t yy_chk[450] = {0,
    1,
    1,
    1,
    1,
...
#line 677 "frontend/parser/lexer.cpp"
#line 678 "frontend/parser/lexer.cpp"
...
#line 885 "frontend/parser/lexer.cpp"
        ...
        yy_match:
            do {
                ...
                while (yy_chk[yy_base[yy_current_state] + yy_c] != yy_current_state)
                {
                    ...
                    if (yy_current_state >= 115) yy_c = yy_meta[yy_c];
                }
...
#line 88 "frontend/parser/lexer.l"
                    {
                        ...
                        if (nl > 0)
                        {
                            ...
                            loc.end = loc.begin;
                            loc.lines(nl);
                            int tail = yyleng - (last_n + 1);
                            if (tail > 0) loc.columns(tail);
                        }
                    }
                    YY_BREAK
...
#line 149 "frontend/parser/lexer.l"
                    {
                        try
                        {
...
#line 184 "frontend/parser/lexer.l"
                        {RETT(LPAREN, loc)} YY_BREAK case 27 : YY_RULE_SETUP
#line 185 "frontend/parser/lexer.l"
                                                               {RETT(RPAREN, loc)} YY_BREAK case 28
                        : YY_RULE_SETUP
#line 186 "frontend/parser/lexer.l"
                          {RETT(LBRACKET, loc)} YY_BREAK case 29 : YY_RULE_SETUP
#line 187 "frontend/parser/lexer.l"
                                                                   {RETT(RBRACKET, loc)} YY_BREAK case 30
                        : YY_RULE_SETUP
#line 188 "frontend/parser/lexer.l"
                          {RETT(LBRACE, loc)} YY_BREAK case 31 : YY_RULE_SETUP
#line 189 "frontend/parser/lexer.l"
                                                                 {RETT(RBRACE, loc)} YY_BREAK case 32
                        : YY_RULE_SETUP
#line 191 "frontend/parser/lexer.l"
                          {RETT(PLUS, loc)} YY_BREAK case 33 : YY_RULE_SETUP
#line 192 "frontend/parser/lexer.l"
                                                               {RETT(MINUS, loc)} YY_BREAK case 34
                        : YY_RULE_SETUP
#line 193 "frontend/parser/lexer.l"
                          {RETT(STAR, loc)} YY_BREAK case 35 : YY_RULE_SETUP
#line 194 "frontend/parser/lexer.l"
                                                               {RETT(SLASH, loc)} YY_BREAK case 36
                        : YY_RULE_SETUP
#line 195 "frontend/parser/lexer.l"
                          {RETT(MOD, loc)} YY_BREAK case 37 : YY_RULE_SETUP
#line 197 "frontend/parser/lexer.l"
                                                              {RETT(ASSIGN, loc)} YY_BREAK case 38
                        : YY_RULE_SETUP
#line 199 "frontend/parser/lexer.l"
                          {RETT(EQ, loc)} YY_BREAK case 39 : YY_RULE_SETUP
#line 200 "frontend/parser/lexer.l"
                                                             {RETT(NE, loc)} YY_BREAK case 40
                        : YY_RULE_SETUP
#line 201 "frontend/parser/lexer.l"
                          {RETT(LT, loc)} YY_BREAK case 41 : YY_RULE_SETUP
#line 202 "frontend/parser/lexer.l"
                                                             {RETT(LE, loc)} YY_BREAK case 42
                        : YY_RULE_SETUP
#line 203 "frontend/parser/lexer.l"
                          {RETT(GT, loc)} YY_BREAK case 43 : YY_RULE_SETUP
#line 204 "frontend/parser/lexer.l"
                                                             {RETT(GE, loc)} YY_BREAK case 44
                        : YY_RULE_SETUP
#line 206 "frontend/parser/lexer.l"
                          {RETT(AND, loc)} YY_BREAK case 45 : YY_RULE_SETUP
#line 207 "frontend/parser/lexer.l"
                                                              {RETT(OR, loc)} YY_BREAK case 46
                        : YY_RULE_SETUP
#line 208 "frontend/parser/lexer.l"
                          {RETT(NOT, loc)} YY_BREAK case YY_STATE_EOF(INITIAL)
                        :
...
#line 212 "frontend/parser/lexer.l"
                    ECHO;
                    YY_BREAK
#line 1294 "frontend/parser/lexer.cpp"
